...
setup(
    ...
    author="Anshuman Jha",
    author_email="anshuman.jha2025@gmail.com",
    maintainer="Anshuman Jha",
    maintainer_email="anshuman.jha2025@gmail.com",
    url="https://github.com/DaRkLord0350/Web-Scraping",
    license="MIT",
    packages=find_packages(),
    entry_points={"console_scripts": ["scrape = scrape.scrape:command_line_runner"]},
    install_requires=["lxml", "pdfkit", "requests", "tldextract"],
)
